...
`;function ct(t,e,i,n={}){n=n||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return s.detail=i,t.dispatchEvent(s),s}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var n=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css","top"===i&&n.firstChild?n.insertBefore(s,n.firstChild):n.appendChild(s),s.styleSheet?s.styleSheet.cssText=t:s.appendChild(document.createTextNode(t))}}(lt);const dt=[0,1],ht=[.5,1],ut=["column","row"],pt=["climate","fan","humidifier"],ft={header:{},layout:{mode:{}}};class vt extends at{static get styles(){return lt}static get properties(){return{hass:{},config:{}}}static getStubConfig(){return Object.assign({},ft)}setConfig(t){this.config=t||Object.assign({},ft)}_openLink(){window.open("https://github.com/Wheemer/simple-thermostat/blob/master/README.md")}render(){var t,e,i,n,s,o,a,r,l,c,d,h,u,p,f,v,g,m,y,_,b,$,w,x,A,E,O;return this.hass?L`
  ...
  `}var kt,Tt={exports:{}};function Pt(){return kt||(kt=1,function(t){function e(t){var i,n,s=new Error(t);return i=s,n=e.prototype,Object.setPrototypeOf?Object.setPrototypeOf(i,n):i.__proto__=n,s}function i(t,i,n){var s=i.slice(0,n).split(/\n/),o=s.length,a=s[o-1].length+1;throw e(t+=" at line "+o+" col "+a+":\n\n  "+i.split(/\n/)[o-1]+"\n  "+Array(a).join(" ")+"^")}e.prototype=Object.create(Error.prototype,{name:{value:"Squirrelly Error",enumerable:!1}});var n=new Function("return this")().Promise,s=!1;try{s=new Function("return (async function(){}).constructor")()}catch(t){if(!(t instanceof SyntaxError))throw t}function o(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function a(t,e,i){for(var n in e)o(e,n)&&(null==e[n]||"object"!=typeof e[n]||"storage"!==n&&"prefixes"!==n||i?t[n]=e[n]:t[n]=a({},e[n]));return t}var r=/^async +/,l=/`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g,c=/'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g,d=/"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g,h=/[.*+\-?^${}()|[\]\\]/g;function u(t){return h.test(t)?t.replace(h,"\\$&"):t}function p(t,n){n.rmWhitespace&&(t=t.replace(/[\r\n]+/g,"\n").replace(/^\s+|\s+$/gm,"")),l.lastIndex=0,c.lastIndex=0,d.lastIndex=0;var s=n.prefixes,o=[s.h,s.b,s.i,s.r,s.c,s.e].reduce(function(t,e){return t&&e?t+"|"+u(e):e?u(e):t},""),a=new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?"+u(n.tags[1])+")","g"),h=new RegExp("([^]*?)"+u(n.tags[0])+"(-|_)?\\s*("+o+")?\\s*","g"),p=0,f=!1;function v(e,s){var o,u={f:[]},v=0,g="c";function m(e){var s=t.slice(p,e),o=s.trim();if("f"===g)"safe"===o?u.raw=!0:n.async&&r.test(o)?(o=o.replace(r,""),u.f.push([o,"",!0])):u.f.push([o,""]);else if("fp"===g)u.f[u.f.length-1][1]+=o;else if("err"===g){if(o){var a=s.search(/\S/);i("invalid syntax",t,p+a)}}else u[g]=o;p=e+1}for("h"===s||"b"===s||"c"===s?g="n":"r"===s&&(u.raw=!0,s="i"),a.lastIndex=p;null!==(o=a.exec(t));){var y=o[1],_=o[2],b=o[3],$=o[4],w=o[5],x=o.index;if(y)"("===y?(0===v&&("n"===g?(m(x),g="p"):"f"===g&&(m(x),g="fp")),v++):")"===y?0===--v&&"c"!==g&&(m(x),g="err"):0===v&&"|"===y?(m(x),g="f"):"=>"===y&&(m(x),p+=1,g="res");else if(_)if("/*"===_){var A=t.indexOf("*/",a.lastIndex);-1===A&&i("unclosed comment",t,o.index),a.lastIndex=A+2}else"'"===_?(c.lastIndex=o.index,c.exec(t)?a.lastIndex=c.lastIndex:i("unclosed string",t,o.index)):'"'===_?(d.lastIndex=o.index,d.exec(t)?a.lastIndex=d.lastIndex:i("unclosed string",t,o.index)):"`"===_&&(l.lastIndex=o.index,l.exec(t)?a.lastIndex=l.lastIndex:i("unclosed string",t,o.index));else if(b)return m(x),p=x+o[0].length,h.lastIndex=p,f=w,$&&"h"===s&&(s="s"),u.t=s,u}return i("unclosed tag",t,e),u}var g=function o(a,l){a.b=[],a.d=[];var c,d=!1,u=[];function g(t,e){t&&(t=function(t,e,i,n){var s,o;return"string"==typeof e.autoTrim?s=o=e.autoTrim:Array.isArray(e.autoTrim)&&(s=e.autoTrim[1],o=e.autoTrim[0]),(i||!1===i)&&(s=i),(n||!1===n)&&(o=n),"slurp"===s&&"slurp"===o?t.trim():("_"===s||"slurp"===s?t=String.prototype.trimLeft?t.trimLeft():t.replace(/^[\s\uFEFF\xA0]+/,""):"-"!==s&&"nl"!==s||(t=t.replace(/^(?:\n|\r|\r\n)/,"")),"_"===o||"slurp"===o?t=String.prototype.trimRight?t.trimRight():t.replace(/[\s\uFEFF\xA0]+$/,""):"-"!==o&&"nl"!==o||(t=t.replace(/(?:\n|\r|\r\n)$/,"")),t)}(t,n,f,e))&&(t=t.replace(/\\|'/g,"\\$&").replace(/\r\n|\n|\r/g,"\\n"),u.push(t))}for(;null!==(c=h.exec(t));){var m,y=c[1],_=c[2],b=c[3]||"";for(var $ in s)if(s[$]===b){m=$;break}g(y,_),p=c.index+c[0].length,m||i("unrecognized tag type: "+b,t,p);var w=v(c.index,m),x=w.t;if("h"===x){var A=w.n||"";n.async&&r.test(A)&&(w.a=!0,w.n=A.replace(r,"")),w=o(w),u.push(w)}else if("c"===x){if(a.n===w.n)return d?(d.d=u,a.b.push(d)):a.d=u,a;i("Helper start and end don't match",t,c.index+c[0].length)}else if("b"===x){d?(d.d=u,a.b.push(d)):a.d=u;var E=w.n||"";n.async&&r.test(E)&&(w.a=!0,w.n=E.replace(r,"")),d=w,u=[]}else if("s"===x){var O=w.n||"";n.async&&r.test(O)&&(w.a=!0,w.n=O.replace(r,"")),u.push(w)}else u.push(w)}if(!l)throw e('unclosed helper "'+a.n+'"');return g(t.slice(p,t.length),!1),a.d=u,a}({f:[]},!0);if(n.plugins)for(var m=0;m<n.plugins.length;m++){var y=n.plugins[m];y.processAST&&(g.d=y.processAST(g.d,n))}return g.d}function f(t,e){var i=p(t,e),n="var tR='';"+(e.useWith?"with("+e.varName+"||{}){":"")+_(i,e)+"if(cb){cb(null,tR)} return tR"+(e.useWith?"}":"");if(e.plugins)for(var s=0;s<e.plugins.length;s++){var o=e.plugins[s];o.processFnString&&(n=o.processFnString(n,e))}return n}function v(t,e){for(var i=0;i<e.length;i++){var n=e[i][0],s=e[i][1];t=(e[i][2]?"await ":"")+"c.l('F','"+n+"')("+t,s&&(t+=","+s),t+=")"}return t}function g(t,e,i,n,s,o){var a="{exec:"+(s?"async ":"")+y(i,e,t)+",params:["+n+"]";return o&&(a+=",name:'"+o+"'"),s&&(a+=",async:true"),a+"}"}function m(t,e){for(var i="[",n=0;n<t.length;n++){var s=t[n];i+=g(e,s.res||"",s.d,s.p||"",s.a,s.n),n<t.length&&(i+=",")}return i+"]"}function y(t,e,i){return"function("+e+"){var tR='';"+_(t,i)+"return tR}"}function _(t,e){for(var i=0,n=t.length,s="";i<n;i++){var o=t[i];if("string"==typeof o)s+="tR+='"+o+"';";else{var a=o.t,r=o.c||"",l=o.f,c=o.n||"",d=o.p||"",h=o.res||"",u=o.b,p=!!o.a;if("i"===a){e.defaultFilter&&(r="c.l('F','"+e.defaultFilter+"')("+r+")");var f=v(r,l);!o.raw&&e.autoEscape&&(f="c.l('F','e')("+f+")"),s+="tR+="+f+";"}else if("h"===a)if(e.storage.nativeHelpers.get(c))s+=e.storage.nativeHelpers.get(c)(o,e);else{var y=(p?"await ":"")+"c.l('H','"+c+"')("+g(e,h,o.d,d,p);y+=u?","+m(u,e):",[]",s+="tR+="+v(y+=",c)",l)+";"}else"s"===a?s+="tR+="+v((p?"await ":"")+"c.l('H','"+c+"')({params:["+d+"]},[],c)",l)+";":"e"===a&&(s+=r+"\n")}}return s}var b=function(){function t(t){this.cache=t}return t.prototype.define=function(t,e){this.cache[t]=e},t.prototype.get=function(t){return this.cache[t]},t.prototype.remove=function(t){delete this.cache[t]},t.prototype.reset=function(){this.cache={}},t.prototype.load=function(t){a(this.cache,t,!0)},t}();function $(t,i,n,s){if(i&&i.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept blocks");if(n&&n.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept filters")}var w={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function x(t){return w[t]}var A=new b({}),E=new b({each:function(t,e){var i="",n=t.params[0];if($("each",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,o){n(e[i],i).then(function(a){s+=a,i===e.length-1?o(s):t(e,i+1,n,s,o)})}(n,0,t.exec,i,e)});for(var s=0;s<n.length;s++)i+=t.exec(n[s],s);return i},foreach:function(t,e){var i=t.params[0];if($("foreach",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,o,a){s(i[n],e[i[n]]).then(function(r){o+=r,n===i.length-1?a(o):t(e,i,n+1,s,o,a)})}(i,Object.keys(i),0,t.exec,"",e)});var n="";for(var s in i)o(i,s)&&(n+=t.exec(s,i[s]));return n},include:function(t,i,n){$("include",i,!1);var s=n.storage.templates.get(t.params[0]);if(!s)throw e('Could not fetch template "'+t.params[0]+'"');return s(t.params[1],n)},extends:function(t,i,n){var s=t.params[1]||{};s.content=t.exec();for(var o=0;o<i.length;o++){var a=i[o];s[a.name]=a.exec()}var r=n.storage.templates.get(t.params[0]);if(!r)throw e('Could not fetch template "'+t.params[0]+'"');return r(s,n)},useScope:function(t,e){return $("useScope",e,!1),t.exec(t.params[0])}}),O=new b({if:function(t,e){$("if",!1,t.f,!0);var i="if("+t.p+"){"+_(t.d,e)+"}";if(t.b)for(var n=0;n<t.b.length;n++){var s=t.b[n];"else"===s.n?i+="else{"+_(s.d,e)+"}":"elif"===s.n&&(i+="else if("+s.p+"){"+_(s.d,e)+"}")}return i},try:function(t,i){if($("try",!1,t.f,!0),!t.b||1!==t.b.length||"catch"!==t.b[0].n)throw e("native helper 'try' only accepts 1 block, 'catch'");var n="try{"+_(t.d,i)+"}",s=t.b[0];return n+"catch"+(s.res?"("+s.res+")":"")+"{"+_(s.d,i)+"}"},block:function(t,e){return $("block",t.b,t.f,!0),"if(!"+e.varName+"["+t.p+"]){tR+=("+y(t.d,"",e)+")()}else{tR+="+e.varName+"["+t.p+"]}"}}),S=new b({e:function(t){var e=String(t);return/[&<>"']/.test(e)?e.replace(/[&<>"']/g,x):e}}),C={varName:"it",autoTrim:[!1,"nl"],autoEscape:!0,defaultFilter:!1,tags:["{{","}}"],l:function(t,i){if("H"===t){var n=this.storage.helpers.get(i);if(n)return n;throw e("Can't find helper '"+i+"'")}if("F"===t){var s=this.storage.filters.get(i);if(s)return s;throw e("Can't find filter '"+i+"'")}},async:!1,storage:{helpers:E,nativeHelpers:O,filters:S,templates:A},prefixes:{h:"@",b:"#",i:"",r:"*",c:"/",e:"!"},cache:!1,plugins:[],useWith:!1};function j(t,e){var i={};return a(i,C),e&&a(i,e),t&&a(i,t),i.l.bind(i),i}function k(t,i){var n=j(i||{}),o=Function;if(n.async){if(!s)throw e("This environment doesn't support async/await");o=s}try{return new o(n.varName,"c","cb",f(t,n))}catch(i){throw i instanceof SyntaxError?e("Bad template syntax\n\n"+i.message+"\n"+Array(i.message.length+1).join("=")+"\n"+f(t,n)):i}}function T(t,e){var i;return e.cache&&e.name&&e.storage.templates.get(e.name)?e.storage.templates.get(e.name):(i="function"==typeof t?t:k(t,e),e.cache&&e.name&&e.storage.templates.define(e.name,i),i)}C.l.bind(C),t.compile=k,t.compileScope=_,t.compileScopeIntoFunction=y,t.compileToString=f,t.defaultConfig=C,t.filters=S,t.getConfig=j,t.helpers=E,t.nativeHelpers=O,t.parse=p,t.render=function(t,i,s,o){var a=j(s||{});if(!a.async)return T(t,a)(i,a);if(!o){if("function"==typeof n)return new n(function(e,n){try{e(T(t,a)(i,a))}catch(t){n(t)}});throw e("Please provide a callback function, this env doesn't support Promises")}try{T(t,a)(i,a,o)}catch(t){return o(t)}},t.templates=A,Object.defineProperty(t,"__esModule",{value:!0})}(Tt.exports)),Tt.exports}var Nt=Pt();const zt=2;class It{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class Rt extends It{constructor(t){if(super(t),this.it=W,t.type!==zt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||null==t)return this._t=void 0,this.it=t;if(t===F)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Rt.directiveName="unsafeHTML",Rt.resultType=1;const Ht=(t=>(...e)=>({_$litDirective$:t,values:e}))(Rt),Ut=t=>`<ha-icon icon="${t}"></ha-icon>`;function Mt(t,e){var i,n,s,o;const{type:a,labels:r}=null!==(o=null!==(n=null===(i=null==t?void 0:t.layout)||void 0===i?void 0:i.entities)&&void 0!==n?n:null===(s=null==t?void 0:t.layout)||void 0===s?void 0:s.sensors)&&void 0!==o?o:{type:"table",labels:!0};return L` <div class="entities ${[r?"with-labels":"without-labels","list"===a?"as-list":"as-table"].join(" ")}">${e}</div> `}Nt.defaultConfig.autoEscape=!1,Nt.filters.define("icon",Ut),Nt.filters.define("join",(t,e=", ")=>t.join(e)),Nt.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),Nt.filters.define("debug",t=>{try{return JSON.stringify(t)}catch(e){return`Not able to read valid JSON object from: ${t}`}});const Dt=["automation","fan","humidifier","input_boolean","light","switch"];function Vt({hide:t=!1,hass:e,state:i,details:n,localize:s,openEntityPopover:o}){var a,r,l;if(t||void 0===i)return;const{type:c,heading:d,icon:h,unit:u,decimals:p}=n;let f;if(process.env.DEBUG&&console.log("ST: infoItem",{state:i,details:n}),"relativetime"===c)f=L`
    ...
    `;else if("object"==typeof i){const[t]=i.entity_id.split(".");if(Dt.includes(t))f=L`
      ...
      `;else{const n=["component",t,"state",null!==(r=null===(a=i.attributes)||void 0===a?void 0:a.device_class)&&void 0!==r?r:"_",""].join(".");let l="function"==typeof e.formatEntityState?e.formatEntityState(i):s(i.state,n);"number"==typeof p&&(l=Ct(i.state,{decimals:p,locale:e.locale}));const c="function"==typeof e.formatEntityState&&"number"!=typeof p;f=L`
        <div
      ...
      `}}else{let t="number"==typeof p?Ct(i,{decimals:p,locale:e.locale}):i;f=L` <div class="entity-value">${t}${u}</div> `}if(!1===d)return f;const v=d||(null===(l=null==i?void 0:i.attributes)||void 0===l?void 0:l.friendly_name)||(null==i?void 0:i.entity_id),g="object"==typeof i?i.entity_id:null,m=h?L` <ha-icon
        icon="${h}"
        title=${v}
        @click=${g?()=>o(g):null}
  ...
  `}!function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(Lt||(Lt={}));const Wt={auto:"mdi:radiator",cooling:"mdi:snowflake",fan:"mdi:fan",heating:"mdi:radiator",idle:"mdi:radiator-disabled",off:"mdi:radiator-off"},Bt={auto:"hass:autorenew",cool:"hass:snowflake",dry:"hass:water-percent",fan_only:"hass:fan",heat_cool:"hass:autorenew",heat:"hass:fire",off:"hass:power",forward:"mdi:arrow-right",reverse:"mdi:arrow-left",true:"mdi:fan",false:"mdi:fan-off",normal:"mdi:water-percent",away:"mdi:home-export-outline",boost:"mdi:weather-windy"};function qt(t,e){var i,n;const s=e.states[t.entity];let o="";return o=!0===(null==t?void 0:t.name)?s.attributes.name:null!==(i=null==t?void 0:t.name)&&void 0!==i?i:"",{entity:s,label:o,icon:null!==(n=null==t?void 0:t.icon)&&void 0!==n&&n}}function Gt(t,e){return[...(null==t?void 0:t.toggle)?[t.toggle]:[],...Array.isArray(null==t?void 0:t.toggles)?t.toggles:[]].map(t=>qt(t,e))}function Jt(t,e){return Array.isArray(t)?t.map(t=>{var{entity:i}=t,n=gt(t,["entity"]);return Object.assign(Object.assign({},n),{state:e.states[i],entity:i})}):[]}const Zt={climate:"set_temperature",fan:"set_percentage",humidifier:"set_humidity"};var Yt;!function(t){t.HVAC="hvac",t.FAN="fan",t.PRESET="preset",t.SWING="swing",t.SWING_HORIZONTAL="swing_horizontal",t.SWING_VERTICAL="swing_vertical",t.VANE_HORIZONTAL="vane_horizontal",t.VANE_VERTICAL="vane_vertical",t.DIRECTION="direction",t.OSCILLATING="oscillating",t.MODE="mode"}(Yt||(Yt={}));const Kt=Object.values(Yt),Qt=[Yt.VANE_HORIZONTAL,Yt.VANE_VERTICAL];function Xt(t){return t===Yt.DIRECTION?"direction":t===Yt.OSCILLATING?"oscillating":t===Yt.MODE?"available_modes":Qt.includes(t)?`${t}_positions`:`${t}_modes`}const te={climate:[Yt.HVAC,Yt.PRESET],fan:[Yt.PRESET,Yt.DIRECTION,Yt.OSCILLATING],humidifier:[Yt.MODE]},ee="hass:chevron-up",ie="hass:chevron-down",ne="mdi:plus",se="mdi:minus",oe={temperature:!1,state:!1};function ae(t,e,i={}){let n=e[Xt(t)];return t===Yt.DIRECTION&&e.direction?n=["forward","reverse"]:t===Yt.OSCILLATING&&"boolean"==typeof e.oscillating&&(n=[!1,!0]),Array.isArray(n)?n.filter(e=>function(t,e,i){var n;const s=String(e);if("object"==typeof i[s])return!1!==i[s].include;const o=Object.keys(i).some(t=>!t.startsWith("_")),a=t===Yt.PRESET;return null!==(n=null==i?void 0:i[s])&&void 0!==n?n:!(a&&o)}(t,e,i)).map(t=>{const e=String(t),n="object"==typeof i[e]?i[e]:{};return Object.assign({icon:Bt[e],value:e,name:e},n)}):[]}class re extends at{constructor(){super(...arguments),this.modes=[],this._hass={},this.entities=[],this.showEntities=!0,this.name="",this.stepSize=.5,this._values={},this._updatingValues=!1,this._hide=oe,this._debouncedSetTemperature=St(t=>{const{domain:e,service:i,data:n={}}=this.service;this._hass.callService(e,i,Object.assign(Object.assign({entity_id:this.config.entity},n),t))},{wait:500}),this.localize=(t,e="")=>{const i=`${e}${t}`;return this._hass.localize(i)||t},this.toggleEntityChanged=(t,e)=>{if(!this.header||!e)return;const i=t.target;this._hass.callService("homeassistant",i.checked?"turn_on":"turn_off",{entity_id:e})},this.setMode=(t,e)=>{t&&e?(t===Yt.DIRECTION||t===Yt.OSCILLATING?this._hass.callService("fan",`set_${t}`,{entity_id:this.config.entity,[t]:t===Yt.OSCILLATING?"true"===e:e}):t===Yt.MODE?this._hass.callService("humidifier","set_mode",{entity_id:this.config.entity,mode:e}):Qt.includes(t)?this._hass.callService("climate",`set_${t}`,{entity_id:this.config.entity,[`${t}`]:e}):this._hass.callService("climate",`set_${t}_mode`,{entity_id:this.config.entity,[`${t}_mode`]:e}),ct(this,"haptic","light")):ct(this,"haptic","failure")},this.openEntityPopover=(t=null)=>{ct(this,"hass-more-info",{entityId:t||this.config.entity})}}static get styles(){return lt}static getConfigElement(){return window.document.createElement(`${t}-editor`)}setConfig(t){this.config=Object.assign({decimals:1},t)}updated(){super.connectedCallback();const t=Array.from(this.renderRoot.querySelectorAll("[with-hass]"));for(const e of Array.from(t))Array.from(e.attributes).forEach(t=>{t.name.startsWith("fwd-")&&(e[t.name.replace("fwd-","")]=t.value)}),e.hass=this._hass}set hass(t){var e,i,n,s,o,a,r;if(!this.config.entity)return;if(!(null==t?void 0:t.states))return;const l=t.states[this.config.entity];if(!l)return;this._hass=t,this.entity!==l&&(this.entity=l);const c=this.config.entity.split(".")[0];this.header=function(t,e,i){if(!1===t)return!1;let n;n="string"==typeof(null==t?void 0:t.name)?t.name:!1!==(null==t?void 0:t.name)&&e.attributes.friendly_name;let s=e.attributes.hvac_action?Wt:Bt;return void 0!==(null==t?void 0:t.icon)&&(s=t.icon),{name:n,icon:s,toggle:(null==t?void 0:t.toggle)?qt(t.toggle,i):null,toggles:Gt(t,i),faults:Jt(null==t?void 0:t.faults,i)}}(this.config.header,l,t),this.service=function(t,e="climate"){var i;return t||{domain:e,service:null!==(i=Zt[e])&&void 0!==i?i:"set_temperature"}}(null!==(i=null===(e=this.config)||void 0===e?void 0:e.service)&&void 0!==i&&i,c);const d=l.attributes;let h=function(t,e,i="climate"){if(!1===t)return{};if(t)return Object.keys(t).reduce((i,n)=>{const s=t[n];return(null==s?void 0:s.hide)?i:Object.assign(Object.assign({},i),{[n]:null==e?void 0:e[n]})},{});if("fan"===i)return{percentage:e.percentage};if("humidifier"===i)return{humidity:e.humidity};const n=function(t){return"number"==typeof t.target_temp_high&&"number"==typeof t.target_temp_low?"dual":"single"}(e);return"dual"===n?{target_temp_low:e.target_temp_low,target_temp_high:e.target_temp_high}:{temperature:e.temperature}}(null!==(s=null===(n=this.config)||void 0===n?void 0:n.setpoints)&&void 0!==s?s:null,d,c);this._updatingValues&&function(t,e){const i=Object.keys(t);return i.length===Object.keys(e).length&&!i.some(i=>(null==t?void 0:t[i])!==(null==e?void 0:e[i]))}(h,this._values)?this._updatingValues=!1:this._updatingValues||(this._values=h);const u=t=>Kt.includes(t)&&void 0!==d[Xt(t)],p=t=>t.filter(u).map(t=>({type:t,hide_when_off:!1,list:ae(t,d)}));let f=[];if(!1===this.config.control)f=[];else if(Array.isArray(this.config.control))f=p(this.config.control);else if("object"==typeof this.config.control){const t=Object.entries(this.config.control);f=t.length>0?t.filter(([t])=>u(t)).map(([t,e])=>{const{_name:i,_hide_when_off:n,_icons:s}=e,o=gt(e,["_name","_hide_when_off","_icons"]);return{type:t,hide_when_off:n,icons:s,name:i,list:ae(t,d,o)}}):p(null!==(o=te[c])&&void 0!==o?o:te.climate)}else f=p(null!==(a=te[c])&&void 0!==a?a:te.climate);this.modes=f.map(t=>{if(t.type===Yt.HVAC){const e=[],i=Object.values(Lt);return t.list.forEach(t=>{const n=i.indexOf(t.value);e[n]=t}),Object.assign(Object.assign({},t),{list:e,mode:l.state})}const e=Qt.includes(t.type)||t.type===Yt.DIRECTION||t.type===Yt.OSCILLATING?t.type:`${t.type}_mode`,i=d[e];return Object.assign(Object.assign({},t),{mode:i})}),this.config.step_size&&(this.stepSize=+this.config.step_size),this.config.hide&&(this._hide=Object.assign(Object.assign({},this._hide),this.config.hide));const v=function(t){var e,i;return null!==(i=null!==(e=t.entities)&&void 0!==e?e:t.sensors)&&void 0!==i?i:[]}(this.config);if(!1===v)this.showEntities=!1;else if(3===this.config.version){this.entities=[];const t=v.map((t,e)=>{var i,n;const s=null!==(i=null==t?void 0:t.entity)&&void 0!==i?i:this.config.entity;let o=this.entity;return(null==t?void 0:t.entity)&&(o=this._hass.states[t.entity]),{id:null!==(n=null==t?void 0:t.id)&&void 0!==n?n:String(e),label:null==t?void 0:t.label,template:t.template,show:!1!==(null==t?void 0:t.show),entityId:s,context:o}}),e=t.map(t=>t.id),i=[];if(e.includes("state")||i.push({id:"state",label:"{{ui.operation}}",template:"{{state.text}}",entityId:this.config.entity,context:this.entity}),!e.includes("temperature")){const t=null!==(r=this.config.current_temperature_entity)&&void 0!==r?r:this.config.entity,e=this.config.current_temperature_entity?this._hass.states[this.config.current_temperature_entity]:this.entity;i.push({id:"temperature",label:"{{ui.currently}}",template:"{{current_temperature|formatNumber}}",entityId:t,context:e})}this.entities=[...i,...t]}else v&&(this.entities=v.map(e=>{var i,{name:n,entity:s,attribute:o,unit:a=""}=e,r=gt(e,["name","entity","attribute","unit"]);let l;const c=[n];return s?(l=t.states[s],c.push(null===(i=null==l?void 0:l.attributes)||void 0===i?void 0:i.friendly_name),o&&(l=l.attributes[o])):o&&o in this.entity.attributes&&(l=this.entity.attributes[o],c.push(o)),c.push(s),Object.assign(Object.assign({},r),{name:c.find(t=>!!t),state:l,entity:s,unit:a})}))}render({_hide:t,_values:e,_updatingValues:i,config:n,entity:s}=this){var o,a,r;const l=[];if(this.stepSize<1&&0===this.config.decimals&&l.push(L`
        <hui-warning>
  ...
  `}(Object.assign(Object.assign({},t),{variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}))),b=Mt(this.config,b)):b=this.showEntities?function({_hide:t,entity:e,unit:i,hass:n,entities:s,config:o,localize:a,openEntityPopover:r}){var l,c,d,h,u,p,f,v,g,m;const{state:y,attributes:{hvac_action:_,current_temperature:b}}=e,$=o.current_temperature_entity?null===(l=n.states[o.current_temperature_entity])||void 0===l?void 0:l.state:b,w=null===(p=null===(u=null!==(d=null===(c=null==o?void 0:o.layout)||void 0===c?void 0:c.entities)&&void 0!==d?d:null===(h=null==o?void 0:o.layout)||void 0===h?void 0:h.sensors)||void 0===u?void 0:u.labels)||void 0===p||p;let x=a(y,"component.climate.state._.");_&&(x=[a(_,"state_attributes.climate.hvac_action."),` (${x})`].join(""));const A=[Vt({hide:t.temperature,state:`${Ct($,Object.assign(Object.assign({},o),{locale:n.locale}))}${i||""}`,hass:n,details:{heading:!!w&&(null!==(v=null===(f=null==o?void 0:o.label)||void 0===f?void 0:f.temperature)&&void 0!==v?v:a("ui.card.climate.currently"))}}),Vt({hide:t.state,state:x,hass:n,details:{heading:!!w&&(null!==(m=null===(g=null==o?void 0:o.label)||void 0===g?void 0:g.state)&&void 0!==m?m:a("ui.panel.lovelace.editor.card.generic.state"))}}),...s.map(t=>{var{name:e,state:i}=t,s=gt(t,["name","state"]);return Vt({state:i,hass:n,localize:a,openEntityPopover:r,details:Object.assign(Object.assign({},s),{heading:w&&e})})})||null].filter(t=>null!==t);return Mt(o,A)}({_hide:this._hide,unit:g,hass:this._hass,entity:this.entity,entities:this.entities,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",L`
        ...
        <section class="body">
          ...
          ${Object.entries(e).map(([t,e])=>{const o=["string","number"].includes(typeof e),a=!1!==g&&o;return L`
              <div class="current-wrapper ${m}">
                ...
                >
                  ${Ct(e,Object.assign(Object.assign({},n),{fallback:s.state===Lt.OFF?"OFF":n.fallback,locale:this._hass.locale}))}
    ...
    `}setTemperature(t,e){this._updatingValues=!0;const i=this._values[e],n=Number(i)+t,{decimals:s}=this.config;this._values=Object.assign(Object.assign({},this._values),{[e]:+Ct(n,{decimals:s})}),this._debouncedSetTemperature(this._values)}getCardSize(){return 3}getUnit(){var t,e,i,n;if(["boolean","string"].includes(typeof this.config.unit))return null===(t=this.config)||void 0===t?void 0:t.unit;const s=this.config.entity.split(".")[0];return"fan"===s||"humidifier"===s?"%":null!==(n=null===(i=null===(e=this._hass.config)||void 0===e?void 0:e.unit_system)||void 0===i?void 0:i.temperature)&&void 0!==n&&n}}mt([bt()],re.prototype,"config",void 0),mt([bt()],re.prototype,"header",void 0),mt([bt()],re.prototype,"service",void 0),mt([bt()],re.prototype,"modes",void 0),mt([bt()],re.prototype,"entity",void 0),mt([bt()],re.prototype,"entities",void 0),mt([bt()],re.prototype,"showEntities",void 0),mt([bt()],re.prototype,"name",void 0),mt([bt({type:Object})],re.prototype,"_values",void 0),mt([bt()],re.prototype,"_updatingValues",void 0),mt([bt()],re.prototype,"_hide",void 0),customElements.get(t)||customElements.define(t,re),customElements.get(`${t}-editor`)||customElements.define(`${t}-editor`,vt),console.info(`%c${t}: 3.0.45`,"font-weight: bold"),window.customCards=window.customCards||[],window.customCards.push({type:t,name:"Simple Thermostat",preview:!1,description:"A different take on the thermostat card"});

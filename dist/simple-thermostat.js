...
`;function ct(t,e,i,n={}){n=n||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return s.detail=i,t.dispatchEvent(s),s}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var n=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css","top"===i&&n.firstChild?n.insertBefore(s,n.firstChild):n.appendChild(s),s.styleSheet?s.styleSheet.cssText=t:s.appendChild(document.createTextNode(t))}}(lt);const ht=[0,1],dt=[.5,1],ut=["column","row"],pt=["climate"],ft={header:{},layout:{mode:{}}};class vt extends rt{static get styles(){return lt}static get properties(){return{hass:{},config:{}}}static getStubConfig(){return Object.assign({},ft)}setConfig(t){this.config=t||Object.assign({},ft)}_openLink(){window.open("https://github.com/Wheemer/simple-thermostat/blob/master/README.md")}render(){var t,e,i,n,s,o,r,a,l,c,h,d,u,p,f,v,g,m,y,b,_,$,w,x,A,E,O;return this.hass?D`
        ...
        <div class="overall-config">
          ...
          <div class="side-by-side">
            <ha-select
              ...
              .value="${null!==($=null===(_=this.config.decimals)||void 0===_?void 0:_.toString())&&void 0!==$?$:""}"
  ...
  `}var Pt,kt={exports:{}};function Tt(){return Pt||(Pt=1,function(t){function e(t){var i,n,s=new Error(t);return i=s,n=e.prototype,Object.setPrototypeOf?Object.setPrototypeOf(i,n):i.__proto__=n,s}function i(t,i,n){var s=i.slice(0,n).split(/\n/),o=s.length,r=s[o-1].length+1;throw e(t+=" at line "+o+" col "+r+":\n\n  "+i.split(/\n/)[o-1]+"\n  "+Array(r).join(" ")+"^")}e.prototype=Object.create(Error.prototype,{name:{value:"Squirrelly Error",enumerable:!1}});var n=new Function("return this")().Promise,s=!1;try{s=new Function("return (async function(){}).constructor")()}catch(t){if(!(t instanceof SyntaxError))throw t}function o(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function r(t,e,i){for(var n in e)o(e,n)&&(null==e[n]||"object"!=typeof e[n]||"storage"!==n&&"prefixes"!==n||i?t[n]=e[n]:t[n]=r({},e[n]));return t}var a=/^async +/,l=/`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g,c=/'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g,h=/"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g,d=/[.*+\-?^${}()|[\]\\]/g;function u(t){return d.test(t)?t.replace(d,"\\$&"):t}function p(t,n){n.rmWhitespace&&(t=t.replace(/[\r\n]+/g,"\n").replace(/^\s+|\s+$/gm,"")),l.lastIndex=0,c.lastIndex=0,h.lastIndex=0;var s=n.prefixes,o=[s.h,s.b,s.i,s.r,s.c,s.e].reduce(function(t,e){return t&&e?t+"|"+u(e):e?u(e):t},""),r=new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?"+u(n.tags[1])+")","g"),d=new RegExp("([^]*?)"+u(n.tags[0])+"(-|_)?\\s*("+o+")?\\s*","g"),p=0,f=!1;function v(e,s){var o,u={f:[]},v=0,g="c";function m(e){var s=t.slice(p,e),o=s.trim();if("f"===g)"safe"===o?u.raw=!0:n.async&&a.test(o)?(o=o.replace(a,""),u.f.push([o,"",!0])):u.f.push([o,""]);else if("fp"===g)u.f[u.f.length-1][1]+=o;else if("err"===g){if(o){var r=s.search(/\S/);i("invalid syntax",t,p+r)}}else u[g]=o;p=e+1}for("h"===s||"b"===s||"c"===s?g="n":"r"===s&&(u.raw=!0,s="i"),r.lastIndex=p;null!==(o=r.exec(t));){var y=o[1],b=o[2],_=o[3],$=o[4],w=o[5],x=o.index;if(y)"("===y?(0===v&&("n"===g?(m(x),g="p"):"f"===g&&(m(x),g="fp")),v++):")"===y?0===--v&&"c"!==g&&(m(x),g="err"):0===v&&"|"===y?(m(x),g="f"):"=>"===y&&(m(x),p+=1,g="res");else if(b)if("/*"===b){var A=t.indexOf("*/",r.lastIndex);-1===A&&i("unclosed comment",t,o.index),r.lastIndex=A+2}else"'"===b?(c.lastIndex=o.index,c.exec(t)?r.lastIndex=c.lastIndex:i("unclosed string",t,o.index)):'"'===b?(h.lastIndex=o.index,h.exec(t)?r.lastIndex=h.lastIndex:i("unclosed string",t,o.index)):"`"===b&&(l.lastIndex=o.index,l.exec(t)?r.lastIndex=l.lastIndex:i("unclosed string",t,o.index));else if(_)return m(x),p=x+o[0].length,d.lastIndex=p,f=w,$&&"h"===s&&(s="s"),u.t=s,u}return i("unclosed tag",t,e),u}var g=function o(r,l){r.b=[],r.d=[];var c,h=!1,u=[];function g(t,e){t&&(t=function(t,e,i,n){var s,o;return"string"==typeof e.autoTrim?s=o=e.autoTrim:Array.isArray(e.autoTrim)&&(s=e.autoTrim[1],o=e.autoTrim[0]),(i||!1===i)&&(s=i),(n||!1===n)&&(o=n),"slurp"===s&&"slurp"===o?t.trim():("_"===s||"slurp"===s?t=String.prototype.trimLeft?t.trimLeft():t.replace(/^[\s\uFEFF\xA0]+/,""):"-"!==s&&"nl"!==s||(t=t.replace(/^(?:\n|\r|\r\n)/,"")),"_"===o||"slurp"===o?t=String.prototype.trimRight?t.trimRight():t.replace(/[\s\uFEFF\xA0]+$/,""):"-"!==o&&"nl"!==o||(t=t.replace(/(?:\n|\r|\r\n)$/,"")),t)}(t,n,f,e))&&(t=t.replace(/\\|'/g,"\\$&").replace(/\r\n|\n|\r/g,"\\n"),u.push(t))}for(;null!==(c=d.exec(t));){var m,y=c[1],b=c[2],_=c[3]||"";for(var $ in s)if(s[$]===_){m=$;break}g(y,b),p=c.index+c[0].length,m||i("unrecognized tag type: "+_,t,p);var w=v(c.index,m),x=w.t;if("h"===x){var A=w.n||"";n.async&&a.test(A)&&(w.a=!0,w.n=A.replace(a,"")),w=o(w),u.push(w)}else if("c"===x){if(r.n===w.n)return h?(h.d=u,r.b.push(h)):r.d=u,r;i("Helper start and end don't match",t,c.index+c[0].length)}else if("b"===x){h?(h.d=u,r.b.push(h)):r.d=u;var E=w.n||"";n.async&&a.test(E)&&(w.a=!0,w.n=E.replace(a,"")),h=w,u=[]}else if("s"===x){var O=w.n||"";n.async&&a.test(O)&&(w.a=!0,w.n=O.replace(a,"")),u.push(w)}else u.push(w)}if(!l)throw e('unclosed helper "'+r.n+'"');return g(t.slice(p,t.length),!1),r.d=u,r}({f:[]},!0);if(n.plugins)for(var m=0;m<n.plugins.length;m++){var y=n.plugins[m];y.processAST&&(g.d=y.processAST(g.d,n))}return g.d}function f(t,e){var i=p(t,e),n="var tR='';"+(e.useWith?"with("+e.varName+"||{}){":"")+b(i,e)+"if(cb){cb(null,tR)} return tR"+(e.useWith?"}":"");if(e.plugins)for(var s=0;s<e.plugins.length;s++){var o=e.plugins[s];o.processFnString&&(n=o.processFnString(n,e))}return n}function v(t,e){for(var i=0;i<e.length;i++){var n=e[i][0],s=e[i][1];t=(e[i][2]?"await ":"")+"c.l('F','"+n+"')("+t,s&&(t+=","+s),t+=")"}return t}function g(t,e,i,n,s,o){var r="{exec:"+(s?"async ":"")+y(i,e,t)+",params:["+n+"]";return o&&(r+=",name:'"+o+"'"),s&&(r+=",async:true"),r+"}"}function m(t,e){for(var i="[",n=0;n<t.length;n++){var s=t[n];i+=g(e,s.res||"",s.d,s.p||"",s.a,s.n),n<t.length&&(i+=",")}return i+"]"}function y(t,e,i){return"function("+e+"){var tR='';"+b(t,i)+"return tR}"}function b(t,e){for(var i=0,n=t.length,s="";i<n;i++){var o=t[i];if("string"==typeof o)s+="tR+='"+o+"';";else{var r=o.t,a=o.c||"",l=o.f,c=o.n||"",h=o.p||"",d=o.res||"",u=o.b,p=!!o.a;if("i"===r){e.defaultFilter&&(a="c.l('F','"+e.defaultFilter+"')("+a+")");var f=v(a,l);!o.raw&&e.autoEscape&&(f="c.l('F','e')("+f+")"),s+="tR+="+f+";"}else if("h"===r)if(e.storage.nativeHelpers.get(c))s+=e.storage.nativeHelpers.get(c)(o,e);else{var y=(p?"await ":"")+"c.l('H','"+c+"')("+g(e,d,o.d,h,p);y+=u?","+m(u,e):",[]",s+="tR+="+v(y+=",c)",l)+";"}else"s"===r?s+="tR+="+v((p?"await ":"")+"c.l('H','"+c+"')({params:["+h+"]},[],c)",l)+";":"e"===r&&(s+=a+"\n")}}return s}var _=function(){function t(t){this.cache=t}return t.prototype.define=function(t,e){this.cache[t]=e},t.prototype.get=function(t){return this.cache[t]},t.prototype.remove=function(t){delete this.cache[t]},t.prototype.reset=function(){this.cache={}},t.prototype.load=function(t){r(this.cache,t,!0)},t}();function $(t,i,n,s){if(i&&i.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept blocks");if(n&&n.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept filters")}var w={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function x(t){return w[t]}var A=new _({}),E=new _({each:function(t,e){var i="",n=t.params[0];if($("each",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,o){n(e[i],i).then(function(r){s+=r,i===e.length-1?o(s):t(e,i+1,n,s,o)})}(n,0,t.exec,i,e)});for(var s=0;s<n.length;s++)i+=t.exec(n[s],s);return i},foreach:function(t,e){var i=t.params[0];if($("foreach",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,o,r){s(i[n],e[i[n]]).then(function(a){o+=a,n===i.length-1?r(o):t(e,i,n+1,s,o,r)})}(i,Object.keys(i),0,t.exec,"",e)});var n="";for(var s in i)o(i,s)&&(n+=t.exec(s,i[s]));return n},include:function(t,i,n){$("include",i,!1);var s=n.storage.templates.get(t.params[0]);if(!s)throw e('Could not fetch template "'+t.params[0]+'"');return s(t.params[1],n)},extends:function(t,i,n){var s=t.params[1]||{};s.content=t.exec();for(var o=0;o<i.length;o++){var r=i[o];s[r.name]=r.exec()}var a=n.storage.templates.get(t.params[0]);if(!a)throw e('Could not fetch template "'+t.params[0]+'"');return a(s,n)},useScope:function(t,e){return $("useScope",e,!1),t.exec(t.params[0])}}),O=new _({if:function(t,e){$("if",!1,t.f,!0);var i="if("+t.p+"){"+b(t.d,e)+"}";if(t.b)for(var n=0;n<t.b.length;n++){var s=t.b[n];"else"===s.n?i+="else{"+b(s.d,e)+"}":"elif"===s.n&&(i+="else if("+s.p+"){"+b(s.d,e)+"}")}return i},try:function(t,i){if($("try",!1,t.f,!0),!t.b||1!==t.b.length||"catch"!==t.b[0].n)throw e("native helper 'try' only accepts 1 block, 'catch'");var n="try{"+b(t.d,i)+"}",s=t.b[0];return n+"catch"+(s.res?"("+s.res+")":"")+"{"+b(s.d,i)+"}"},block:function(t,e){return $("block",t.b,t.f,!0),"if(!"+e.varName+"["+t.p+"]){tR+=("+y(t.d,"",e)+")()}else{tR+="+e.varName+"["+t.p+"]}"}}),S=new _({e:function(t){var e=String(t);return/[&<>"']/.test(e)?e.replace(/[&<>"']/g,x):e}}),j={varName:"it",autoTrim:[!1,"nl"],autoEscape:!0,defaultFilter:!1,tags:["{{","}}"],l:function(t,i){if("H"===t){var n=this.storage.helpers.get(i);if(n)return n;throw e("Can't find helper '"+i+"'")}if("F"===t){var s=this.storage.filters.get(i);if(s)return s;throw e("Can't find filter '"+i+"'")}},async:!1,storage:{helpers:E,nativeHelpers:O,filters:S,templates:A},prefixes:{h:"@",b:"#",i:"",r:"*",c:"/",e:"!"},cache:!1,plugins:[],useWith:!1};function C(t,e){var i={};return r(i,j),e&&r(i,e),t&&r(i,t),i.l.bind(i),i}function P(t,i){var n=C(i||{}),o=Function;if(n.async){if(!s)throw e("This environment doesn't support async/await");o=s}try{return new o(n.varName,"c","cb",f(t,n))}catch(i){throw i instanceof SyntaxError?e("Bad template syntax\n\n"+i.message+"\n"+Array(i.message.length+1).join("=")+"\n"+f(t,n)):i}}function k(t,e){var i;return e.cache&&e.name&&e.storage.templates.get(e.name)?e.storage.templates.get(e.name):(i="function"==typeof t?t:P(t,e),e.cache&&e.name&&e.storage.templates.define(e.name,i),i)}j.l.bind(j),t.compile=P,t.compileScope=b,t.compileScopeIntoFunction=y,t.compileToString=f,t.defaultConfig=j,t.filters=S,t.getConfig=C,t.helpers=E,t.nativeHelpers=O,t.parse=p,t.render=function(t,i,s,o){var r=C(s||{});if(!r.async)return k(t,r)(i,r);if(!o){if("function"==typeof n)return new n(function(e,n){try{e(k(t,r)(i,r))}catch(t){n(t)}});throw e("Please provide a callback function, this env doesn't support Promises")}try{k(t,r)(i,r,o)}catch(t){return o(t)}},t.templates=A,Object.defineProperty(t,"__esModule",{value:!0})}(kt.exports)),kt.exports}var zt=Tt();const Nt=2;class Rt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class Ht extends Rt{constructor(t){if(super(t),this.it=W,t.type!==Nt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||null==t)return this._t=void 0,this.it=t;if(t===L)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Ht.directiveName="unsafeHTML",Ht.resultType=1;const It=(t=>(...e)=>({_$litDirective$:t,values:e}))(Ht),Ut=t=>`<ha-icon icon="${t}"></ha-icon>`;function Mt(t,e){var i,n;const{type:s,labels:o}=null!==(n=null===(i=null==t?void 0:t.layout)||void 0===i?void 0:i.sensors)&&void 0!==n?n:{type:"table",labels:!0};return D` <div class="sensors ${[o?"with-labels":"without-labels","list"===s?"as-list":"as-table"].join(" ")}">${e}</div> `}function Vt({hide:t=!1,hass:e,state:i,details:n,localize:s,openEntityPopover:o}){var r,a;if(t||void 0===i)return;const{type:l,heading:c,icon:h,unit:d,decimals:u}=n;let p;if(process.env.DEBUG&&console.log("ST: infoItem",{state:i,details:n}),"relativetime"===l)p=D`
    ...
    ${p}
  `}var Ft;function Dt({state:t,mode:e,modeOptions:i,localize:n,setMode:s}){var o;const{type:r,hide_when_off:a,mode:l="none",list:c,name:h,icons:d}=e;if(0===c.length||a&&t===Ft.OFF)return null;let u=`state_attributes.climate.${r}_mode.`;"hvac"===r?u="component.climate.state._.":"vane_horizontal"!==r&&"vane_vertical"!==r||(u="");let p;p="vane_horizontal"===r?"Vane Horizontal":"vane_vertical"===r?"Vane Vertical":n(`ui.card.climate.${"hvac"==r?"operation":`${r}_mode`}`);const f=h||p,v=null===(o=null==i?void 0:i.headings)||void 0===o||o;return D`
    <div class="modes ${v?"heading":""}">
      ${v?D` <div class="mode-title">${f}</div> `:""}
  ...
  `}zt.defaultConfig.autoEscape=!1,zt.filters.define("icon",Ut),zt.filters.define("join",(t,e=", ")=>t.join(e)),zt.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),zt.filters.define("debug",t=>{try{return JSON.stringify(t)}catch(e){return`Not able to read valid JSON object from: ${t}`}}),function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(Ft||(Ft={}));const Lt={auto:"mdi:radiator",cooling:"mdi:snowflake",fan:"mdi:fan",heating:"mdi:radiator",idle:"mdi:radiator-disabled",off:"mdi:radiator-off"},Wt={auto:"hass:autorenew",cool:"hass:snowflake",dry:"hass:water-percent",fan_only:"hass:fan",heat_cool:"hass:autorenew",heat:"hass:fire",off:"hass:power"};function Bt(t,e){var i;const n=e.states[t.entity];let s="";return s=!0===(null==t?void 0:t.name)?n.attributes.name:null!==(i=null==t?void 0:t.name)&&void 0!==i?i:"",{entity:n,label:s}}function qt(t,e){return Array.isArray(t)?t.map(t=>{var{entity:i}=t,n=gt(t,["entity"]);return Object.assign(Object.assign({},n),{state:e.states[i],entity:i})}):[]}var Jt;!function(t){t.HVAC="hvac",t.FAN="fan",t.PRESET="preset",t.SWING="swing",t.VANE_HORIZONTAL="vane_horizontal",t.VANE_VERTICAL="vane_vertical"}(Jt||(Jt={}));const Yt=Object.values(Jt),Zt=[Jt.VANE_HORIZONTAL,Jt.VANE_VERTICAL];function Gt(t){return Zt.includes(t)?`${t}_positions`:`${t}_modes`}const Kt=[Jt.HVAC,Jt.PRESET],Qt="hass:chevron-up",Xt="hass:chevron-down",te="mdi:plus",ee="mdi:minus",ie={temperature:!1,state:!1};function ne(t,e,i={}){return e[Gt(t)].filter(t=>function(t,e){var i;if("object"==typeof e[t])return!1!==e[t].include;const n=Object.keys(e).some(t=>!t.startsWith("_"));return null!==(i=null==e?void 0:e[t])&&void 0!==i?i:!n}(t,i)).map(t=>{const e="object"==typeof i[t]?i[t]:{};return Object.assign({icon:Wt[t],value:t,name:t},e)})}class se extends rt{constructor(){super(...arguments),this.modes=[],this._hass={},this.sensors=[],this.showSensors=!0,this.name="",this.stepSize=.5,this._values={},this._updatingValues=!1,this._hide=ie,this._debouncedSetTemperature=St(t=>{const{domain:e,service:i,data:n={}}=this.service;this._hass.callService(e,i,Object.assign(Object.assign({entity_id:this.config.entity},n),t))},{wait:500}),this.localize=(t,e="")=>{const i=`${e}${t}`;return this._hass.localize(i)||t},this.toggleEntityChanged=t=>{var e,i,n,s;if(!this.header||!(null===(e=null==this?void 0:this.header)||void 0===e?void 0:e.toggle))return;const o=t.target;this._hass.callService("homeassistant",o.checked?"turn_on":"turn_off",{entity_id:null===(s=null===(n=null===(i=this.header)||void 0===i?void 0:i.toggle)||void 0===n?void 0:n.entity)||void 0===s?void 0:s.entity_id})},this.setMode=(t,e)=>{t&&e?(Zt.includes(t)?this._hass.callService("climate",`set_${t}`,{entity_id:this.config.entity,[`${t}`]:e}):this._hass.callService("climate",`set_${t}_mode`,{entity_id:this.config.entity,[`${t}_mode`]:e}),ct(this,"haptic","light")):ct(this,"haptic","failure")},this.openEntityPopover=(t=null)=>{ct(this,"hass-more-info",{entityId:t||this.config.entity})}}static get styles(){return lt}static getConfigElement(){return window.document.createElement(`${t}-editor`)}setConfig(t){this.config=Object.assign({decimals:1},t)}updated(){super.connectedCallback();const t=Array.from(this.renderRoot.querySelectorAll("[with-hass]"));for(const e of Array.from(t))Array.from(e.attributes).forEach(t=>{t.name.startsWith("fwd-")&&(e[t.name.replace("fwd-","")]=t.value)}),e.hass=this._hass}set hass(t){var e,i,n,s,o;if(!this.config.entity)return;if(!(null==t?void 0:t.states))return;const r=t.states[this.config.entity];if(!r)return;this._hass=t,this.entity!==r&&(this.entity=r),this.header=function(t,e,i){if(!1===t)return!1;let n;n="string"==typeof(null==t?void 0:t.name)?t.name:!1!==(null==t?void 0:t.name)&&e.attributes.friendly_name;let s=e.attributes.hvac_action?Lt:Wt;return void 0!==(null==t?void 0:t.icon)&&(s=t.icon),{name:n,icon:s,toggle:(null==t?void 0:t.toggle)?Bt(t.toggle,i):null,faults:qt(null==t?void 0:t.faults,i)}}(this.config.header,r,t),this.service=null!==(i=null===(e=this.config)||void 0===e?void 0:e.service)&&void 0!==i&&i||{domain:"climate",service:"set_temperature"};const a=r.attributes;let l=function(t,e){if(!1===t)return{};if(t)return Object.keys(t).reduce((i,n)=>{const s=t[n];return(null==s?void 0:s.hide)?i:Object.assign(Object.assign({},i),{[n]:null==e?void 0:e[n]})},{});const i=function(t){return"number"==typeof t.target_temp_high&&"number"==typeof t.target_temp_low?"dual":"single"}(e);return"dual"===i?{target_temp_low:e.target_temp_low,target_temp_high:e.target_temp_high}:{temperature:e.temperature}}(null!==(s=null===(n=this.config)||void 0===n?void 0:n.setpoints)&&void 0!==s?s:null,a);this._updatingValues&&function(t,e){const i=Object.keys(t);return i.length===Object.keys(e).length&&!i.some(i=>(null==t?void 0:t[i])!==(null==e?void 0:e[i]))}(l,this._values)?this._updatingValues=!1:this._updatingValues||(this._values=l);const c=t=>Yt.includes(t)&&a[Gt(t)],h=t=>t.filter(c).map(t=>({type:t,hide_when_off:!1,list:ne(t,a)}));let d=[];if(!1===this.config.control)d=[];else if(Array.isArray(this.config.control))d=h(this.config.control);else if("object"==typeof this.config.control){const t=Object.entries(this.config.control);d=t.length>0?t.filter(([t])=>c(t)).map(([t,e])=>{const{_name:i,_hide_when_off:n,_icons:s}=e,o=gt(e,["_name","_hide_when_off","_icons"]);return{type:t,hide_when_off:n,icons:s,name:i,list:ne(t,a,o)}}):h(Kt)}else d=h(Kt);if(this.modes=d.map(t=>{if(t.type===Jt.HVAC){const e=[],i=Object.values(Ft);return t.list.forEach(t=>{const n=i.indexOf(t.value);e[n]=t}),Object.assign(Object.assign({},t),{list:e,mode:r.state})}const e=Zt.includes(t.type)?t.type:`${t.type}_mode`,i=a[e];return Object.assign(Object.assign({},t),{mode:i})}),this.config.step_size&&(this.stepSize=+this.config.step_size),this.config.hide&&(this._hide=Object.assign(Object.assign({},this._hide),this.config.hide)),!1===this.config.sensors)this.showSensors=!1;else if(3===this.config.version){this.sensors=[];const t=this.config.sensors.map((t,e)=>{var i,n;const s=null!==(i=null==t?void 0:t.entity)&&void 0!==i?i:this.config.entity;let o=this.entity;return(null==t?void 0:t.entity)&&(o=this._hass.states[t.entity]),{id:null!==(n=null==t?void 0:t.id)&&void 0!==n?n:String(e),label:null==t?void 0:t.label,template:t.template,show:!1!==(null==t?void 0:t.show),entityId:s,context:o}}),e=t.map(t=>t.id),i=[];if(e.includes("state")||i.push({id:"state",label:"{{ui.operation}}",template:"{{state.text}}",entityId:this.config.entity,context:this.entity}),!e.includes("temperature")){const t=null!==(o=this.config.current_temperature_entity)&&void 0!==o?o:this.config.entity,e=this.config.current_temperature_entity?this._hass.states[this.config.current_temperature_entity]:this.entity;i.push({id:"temperature",label:"{{ui.currently}}",template:"{{current_temperature|formatNumber}}",entityId:t,context:e})}this.sensors=[...i,...t]}else this.config.sensors&&(this.sensors=this.config.sensors.map(e=>{var i,{name:n,entity:s,attribute:o,unit:r=""}=e,a=gt(e,["name","entity","attribute","unit"]);let l;const c=[n];return s?(l=t.states[s],c.push(null===(i=null==l?void 0:l.attributes)||void 0===i?void 0:i.friendly_name),o&&(l=l.attributes[o])):o&&o in this.entity.attributes&&(l=this.entity.attributes[o],c.push(o)),c.push(s),Object.assign(Object.assign({},a),{name:c.find(t=>!!t),state:l,entity:s,unit:r})}))}render({_hide:t,_values:e,_updatingValues:i,config:n,entity:s}=this){var o,r,a;const l=[];if(this.stepSize<1&&0===this.config.decimals&&l.push(D`
      ...
      `;const{attributes:{min_temp:c=null,max_temp:h=null,hvac_action:d}}=s,u=this.getUnit(),p=null!==(a=null===(r=null===(o=this.config)||void 0===o?void 0:o.layout)||void 0===r?void 0:r.step)&&void 0!==a?a:"column",f="row"===p,v=[!this.header&&"no-header",d].filter(t=>!!t);let g;return 3===this.config.version?(g=this.sensors.filter(t=>!1!==t.show).map(t=>function({context:t,entityId:e,template:i="{{state.text}}",label:n,hass:s,variables:o={},config:r,localize:a,openEntityPopover:l}){var c,h,d,u;const{state:p,attributes:f}=t,[v]=e.split("."),g=s.selectedLanguage||s.language,m="ui.card.climate.",y=Object.entries(null!==(h=null===(c=s.resources)||void 0===c?void 0:c[g])&&void 0!==h?h:{}).reduce((t,[e,i])=>(e.startsWith(m)&&(t[e.replace(m,"")]=i),t),{}),b=Object.assign(Object.assign({},f),{state:{raw:p,text:a(p,`component.${v}.state._.`)},ui:y,v:o});zt.filters.define("formatNumber",(t,e={decimals:r.decimals})=>String(jt(t,Object.assign(Object.assign({},e),{locale:s.locale})))),zt.filters.define("relativetime",(t,e={})=>`<ha-relative-time fwd-datetime=${t} with-hass></ha-relative-time>`),zt.filters.define("translate",(t,e="")=>a(t,e||"climate"!==v&&"humidifier"!==v?e:`state_attributes.${v}.${t}`));const _=t=>zt.render(t,b,{useWith:!0}),$=_(i);if(!1===n||!1===(null===(u=null===(d=null==r?void 0:r.layout)||void 0===d?void 0:d.sensors)||void 0===u?void 0:u.labels))return D`<div class="sensor-value">${It($)}</div>`;const w=n||"{{friendly_name}}",x=w.match(/^(mdi|hass):.*/)?Ut(w):_(w);return D`
    <div class="sensor-heading">${It(x)}</div>
    <div class="sensor-value">${It($)}</div>
  `}(Object.assign(Object.assign({},t),{variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}))),g=Mt(this.config,g)):g=this.showSensors?function({_hide:t,entity:e,unit:i,hass:n,sensors:s,config:o,localize:r,openEntityPopover:a}){var l,c,h,d,u,p,f,v;const{state:g,attributes:{hvac_action:m,current_temperature:y}}=e,b=o.current_temperature_entity?null===(l=n.states[o.current_temperature_entity])||void 0===l?void 0:l.state:y,_=null===(d=null===(h=null===(c=null==o?void 0:o.layout)||void 0===c?void 0:c.sensors)||void 0===h?void 0:h.labels)||void 0===d||d;let $=r(g,"component.climate.state._.");m&&($=[r(m,"state_attributes.climate.hvac_action."),` (${$})`].join(""));const w=[Vt({hide:t.temperature,state:`${jt(b,Object.assign(Object.assign({},o),{locale:n.locale}))}${i||""}`,hass:n,details:{heading:!!_&&(null!==(p=null===(u=null==o?void 0:o.label)||void 0===u?void 0:u.temperature)&&void 0!==p?p:r("ui.card.climate.currently"))}}),Vt({hide:t.state,state:$,hass:n,details:{heading:!!_&&(null!==(v=null===(f=null==o?void 0:o.label)||void 0===f?void 0:f.state)&&void 0!==v?v:r("ui.panel.lovelace.editor.card.generic.state"))}}),...s.map(t=>{var{name:e,state:i}=t,s=gt(t,["name","state"]);return Vt({state:i,hass:n,localize:r,openEntityPopover:a,details:Object.assign(Object.assign({},s),{heading:_&&e})})})||null].filter(t=>null!==t);return Mt(o,w)}({_hide:this._hide,unit:u,hass:this._hass,entity:this.entity,sensors:this.sensors,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",D`
    ...
    `}setTemperature(t,e){this._updatingValues=!0;const i=this._values[e],n=Number(i)+t,{decimals:s}=this.config;this._values=Object.assign(Object.assign({},this._values),{[e]:+jt(n,{decimals:s})}),this._debouncedSetTemperature(this._values)}getCardSize(){return 3}getUnit(){var t,e,i,n;return["boolean","string"].includes(typeof this.config.unit)?null===(t=this.config)||void 0===t?void 0:t.unit:null!==(n=null===(i=null===(e=this._hass.config)||void 0===e?void 0:e.unit_system)||void 0===i?void 0:i.temperature)&&void 0!==n&&n}}mt([_t()],se.prototype,"config",void 0),mt([_t()],se.prototype,"header",void 0),mt([_t()],se.prototype,"service",void 0),mt([_t()],se.prototype,"modes",void 0),mt([_t()],se.prototype,"entity",void 0),mt([_t()],se.prototype,"sensors",void 0),mt([_t()],se.prototype,"showSensors",void 0),mt([_t()],se.prototype,"name",void 0),mt([_t({type:Object})],se.prototype,"_values",void 0),mt([_t()],se.prototype,"_updatingValues",void 0),mt([_t()],se.prototype,"_hide",void 0),customElements.get(t)||customElements.define(t,se),customElements.get(`${t}-editor`)||customElements.define(`${t}-editor`,vt),console.info(`%c${t}: 3.0.17`,"font-weight: bold"),window.customCards=window.customCards||[],window.customCards.push({type:t,name:"Simple Thermostat",preview:!1,description:"A different take on the thermostat card"});

      ...
      ${t.map(t=>{var n,s,o,a;const r=null===(n=t.entity)||void 0===n?void 0:n.entity_id;return D`
          <div class="header__toggle">
            <span
              ...
              @click=${()=>e(r)}
              >${t.icon?D`<ha-icon icon="${t.icon}"></ha-icon>`:t.label}
            </span>
            <ha-switch

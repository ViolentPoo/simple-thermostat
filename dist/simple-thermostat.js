...
`;function ct(t,e,i,n={}){n=n||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return s.detail=i,t.dispatchEvent(s),s}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var n=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css","top"===i&&n.firstChild?n.insertBefore(s,n.firstChild):n.appendChild(s),s.styleSheet?s.styleSheet.cssText=t:s.appendChild(document.createTextNode(t))}}(lt);const dt=[0,1],ht=[.5,1],ut=["column","row"],pt=["climate"],ft={header:{},layout:{mode:{}}};class vt extends rt{static get styles(){return lt}static get properties(){return{hass:{},config:{}}}static getStubConfig(){return Object.assign({},ft)}setConfig(t){this.config=t||Object.assign({},ft)}_openLink(){window.open("https://github.com/pmbsa/simple-thermostat/blob/master/README.md")}render(){var t,e,i,n,s,o,r,a,l,c,d,h,u,p,f,v,g,m;return this.hass?D`
  ...
  `}Nt.defaultConfig.autoEscape=!1,Nt.filters.define("icon",Ut),Nt.filters.define("join",(t,e=", ")=>t.join(e)),Nt.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),Nt.filters.define("debug",t=>{try{return JSON.stringify(t)}catch(e){return`Not able to read valid JSON object from: ${t}`}}),function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(Ft||(Ft={}));const Lt={auto:"mdi:radiator",cooling:"mdi:snowflake",fan:"mdi:fan",heating:"mdi:radiator",idle:"mdi:radiator-disabled",off:"mdi:radiator-off"},Wt={auto:"hass:autorenew",cool:"hass:snowflake",dry:"hass:water-percent",fan_only:"hass:fan",heat_cool:"hass:autorenew",heat:"hass:fire",off:"hass:power"};function Bt(t,e){var i;const n=e.states[t.entity];let s="";return s=!0===(null==t?void 0:t.name)?n.attributes.name:null!==(i=null==t?void 0:t.name)&&void 0!==i?i:"",{entity:n,label:s}}function qt(t,e){return Array.isArray(t)?t.map(t=>{var{entity:i}=t,n=gt(t,["entity"]);return Object.assign(Object.assign({},n),{state:e.states[i],entity:i})}):[]}var Jt;!function(t){t.HVAC="hvac",t.FAN="fan",t.PRESET="preset",t.SWING="swing",t.VANE_HORIZONTAL="vane_horizontal",t.VANE_VERTICAL="vane_vertical"}(Jt||(Jt={}));const Yt=Object.values(Jt),Zt=[Jt.VANE_HORIZONTAL,Jt.VANE_VERTICAL];function Gt(t){return Zt.includes(t)?`${t}_positions`:`${t}_modes`}const Kt=[Jt.HVAC,Jt.PRESET],Qt="hass:chevron-up",Xt="hass:chevron-down",te="mdi:plus",ee="mdi:minus",ie={temperature:!1,state:!1};function ne(t,e,i={}){return e[Gt(t)].filter(t=>function(t,e){var i;if("object"==typeof e[t])return!1!==e[t].include;const n=Object.keys(e).some(t=>!t.startsWith("_"));return null!==(i=null==e?void 0:e[t])&&void 0!==i?i:!n}(t,i)).map(t=>{const e="object"==typeof i[t]?i[t]:{};return Object.assign({icon:Wt[t],value:t,name:t},e)})}class se extends rt{constructor(){super(...arguments),this.modes=[],this._hass={},this.sensors=[],this.showSensors=!0,this.name="",this.stepSize=.5,this._values={},this._updatingValues=!1,this._hide=ie,this._debouncedSetTemperature=St(t=>{const{domain:e,service:i,data:n={}}=this.service;this._hass.callService(e,i,Object.assign(Object.assign({entity_id:this.config.entity},n),t))},{wait:500}),this.localize=(t,e="")=>{const i=`${e}${t}`;return this._hass.localize(i)||t},this.toggleEntityChanged=t=>{var e,i,n,s;if(!this.header||!(null===(e=null==this?void 0:this.header)||void 0===e?void 0:e.toggle))return;const o=t.target;this._hass.callService("homeassistant",o.checked?"turn_on":"turn_off",{entity_id:null===(s=null===(n=null===(i=this.header)||void 0===i?void 0:i.toggle)||void 0===n?void 0:n.entity)||void 0===s?void 0:s.entity_id})},this.setMode=(t,e)=>{t&&e?(Zt.includes(t)?this._hass.callService("climate",`set_${t}`,{entity_id:this.config.entity,[`${t}`]:e}):this._hass.callService("climate",`set_${t}_mode`,{entity_id:this.config.entity,[`${t}_mode`]:e}),ct(this,"haptic","light")):ct(this,"haptic","failure")},this.openEntityPopover=(t=null)=>{ct(this,"hass-more-info",{entityId:t||this.config.entity})}}static get styles(){return lt}static getConfigElement(){return window.document.createElement(`${t}-editor`)}setConfig(t){this.config=Object.assign({decimals:1},t)}updated(){super.connectedCallback();const t=Array.from(this.renderRoot.querySelectorAll("[with-hass]"));for(const e of Array.from(t))Array.from(e.attributes).forEach(t=>{t.name.startsWith("fwd-")&&(e[t.name.replace("fwd-","")]=t.value)}),e.hass=this._hass}set hass(t){var e,i,n,s;if(!this.config.entity)return;if(!(null==t?void 0:t.states))return;const o=t.states[this.config.entity];if(!o)return;this._hass=t,this.entity!==o&&(this.entity=o),this.header=function(t,e,i){if(!1===t)return!1;let n;n="string"==typeof(null==t?void 0:t.name)?t.name:!1!==(null==t?void 0:t.name)&&e.attributes.friendly_name;let s=e.attributes.hvac_action?Lt:Wt;return void 0!==(null==t?void 0:t.icon)&&(s=t.icon),{name:n,icon:s,toggle:(null==t?void 0:t.toggle)?Bt(t.toggle,i):null,faults:qt(null==t?void 0:t.faults,i)}}(this.config.header,o,t),this.service=null!==(i=null===(e=this.config)||void 0===e?void 0:e.service)&&void 0!==i&&i||{domain:"climate",service:"set_temperature"};const r=o.attributes;let a=function(t,e){if(!1===t)return{};if(t)return Object.keys(t).reduce((i,n)=>{const s=t[n];return(null==s?void 0:s.hide)?i:Object.assign(Object.assign({},i),{[n]:null==e?void 0:e[n]})},{});const i=function(t){return"number"==typeof t.target_temp_high&&"number"==typeof t.target_temp_low?"dual":"single"}(e);return"dual"===i?{target_temp_low:e.target_temp_low,target_temp_high:e.target_temp_high}:{temperature:e.temperature}}(null!==(s=null===(n=this.config)||void 0===n?void 0:n.setpoints)&&void 0!==s?s:null,r);this._updatingValues&&function(t,e){const i=Object.keys(t);return i.length===Object.keys(e).length&&!i.some(i=>(null==t?void 0:t[i])!==(null==e?void 0:e[i]))}(a,this._values)?this._updatingValues=!1:this._updatingValues||(this._values=a);const l=t=>Yt.includes(t)&&r[Gt(t)],c=t=>t.filter(l).map(t=>({type:t,hide_when_off:!1,list:ne(t,r)}));let d=[];if(!1===this.config.control)d=[];else if(Array.isArray(this.config.control))d=c(this.config.control);else if("object"==typeof this.config.control){const t=Object.entries(this.config.control);d=t.length>0?t.filter(([t])=>l(t)).map(([t,e])=>{const{_name:i,_hide_when_off:n,_icons:s}=e,o=gt(e,["_name","_hide_when_off","_icons"]);return{type:t,hide_when_off:n,icons:s,name:i,list:ne(t,r,o)}}):c(Kt)}else d=c(Kt);if(this.modes=d.map(t=>{if(t.type===Jt.HVAC){const e=[],i=Object.values(Ft);return t.list.forEach(t=>{const n=i.indexOf(t.value);e[n]=t}),Object.assign(Object.assign({},t),{list:e,mode:o.state})}const e=Zt.includes(t.type)?t.type:`${t.type}_mode`,i=r[e];return Object.assign(Object.assign({},t),{mode:i})}),this.config.step_size&&(this.stepSize=+this.config.step_size),this.config.hide&&(this._hide=Object.assign(Object.assign({},this._hide),this.config.hide)),!1===this.config.sensors)this.showSensors=!1;else if(3===this.config.version){this.sensors=[];const t=this.config.sensors.map((t,e)=>{var i,n;const s=null!==(i=null==t?void 0:t.entity)&&void 0!==i?i:this.config.entity;let o=this.entity;return(null==t?void 0:t.entity)&&(o=this._hass.states[t.entity]),{id:null!==(n=null==t?void 0:t.id)&&void 0!==n?n:String(e),label:null==t?void 0:t.label,template:t.template,show:!1!==(null==t?void 0:t.show),entityId:s,context:o}}),e=t.map(t=>t.id),i=[];e.includes("state")||i.push({id:"state",label:"{{ui.operation}}",template:"{{state.text}}",entityId:this.config.entity,context:this.entity}),e.includes("temperature")||i.push({id:"temperature",label:"{{ui.currently}}",template:"{{current_temperature|formatNumber}}",entityId:this.config.entity,context:this.entity}),this.sensors=[...i,...t]}else this.config.sensors&&(this.sensors=this.config.sensors.map(e=>{var i,{name:n,entity:s,attribute:o,unit:r=""}=e,a=gt(e,["name","entity","attribute","unit"]);let l;const c=[n];return s?(l=t.states[s],c.push(null===(i=null==l?void 0:l.attributes)||void 0===i?void 0:i.friendly_name),o&&(l=l.attributes[o])):o&&o in this.entity.attributes&&(l=this.entity.attributes[o],c.push(o)),c.push(s),Object.assign(Object.assign({},a),{name:c.find(t=>!!t),state:l,entity:s,unit:r})}))}render({_hide:t,_values:e,_updatingValues:i,config:n,entity:s}=this){var o,r,a;const l=[];if(this.stepSize<1&&0===this.config.decimals&&l.push(D`
      ...
      `;const{attributes:{min_temp:c=null,max_temp:d=null,hvac_action:h}}=s,u=this.getUnit(),p=null!==(a=null===(r=null===(o=this.config)||void 0===o?void 0:o.layout)||void 0===r?void 0:r.step)&&void 0!==a?a:"column",f="row"===p,v=[!this.header&&"no-header",h].filter(t=>!!t);let g;return 3===this.config.version?(g=this.sensors.filter(t=>!1!==t.show).map(t=>function({context:t,entityId:e,template:i="{{state.text}}",label:n,hass:s,variables:o={},config:r,localize:a,openEntityPopover:l}){var c,d,h,u;const{state:p,attributes:f}=t,[v]=e.split("."),g=s.selectedLanguage||s.language,m="ui.card.climate.",y=Object.entries(null!==(d=null===(c=s.resources)||void 0===c?void 0:c[g])&&void 0!==d?d:{}).reduce((t,[e,i])=>(e.startsWith(m)&&(t[e.replace(m,"")]=i),t),{}),b=Object.assign(Object.assign({},f),{state:{raw:p,text:a(p,`component.${v}.state._.`)},ui:y,v:o});Nt.filters.define("formatNumber",(t,e={decimals:r.decimals})=>String(jt(t,Object.assign(Object.assign({},e),{locale:s.locale})))),Nt.filters.define("relativetime",(t,e={})=>`<ha-relative-time fwd-datetime=${t} with-hass></ha-relative-time>`),Nt.filters.define("translate",(t,e="")=>a(t,e||"climate"!==v&&"humidifier"!==v?e:`state_attributes.${v}.${t}`));const _=t=>Nt.render(t,b,{useWith:!0}),$=_(i);if(!1===n||!1===(null===(u=null===(h=null==r?void 0:r.layout)||void 0===h?void 0:h.sensors)||void 0===u?void 0:u.labels))return D`<div class="sensor-value">${It($)}</div>`;const w=n||"{{friendly_name}}",x=w.match(/^(mdi|hass):.*/)?Ut(w):_(w);return D`
    <div class="sensor-heading">${It(x)}</div>
    <div class="sensor-value">${It($)}</div>
  `}(Object.assign(Object.assign({},t),{variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}))),g=Mt(this.config,g)):g=this.showSensors?function({_hide:t,entity:e,unit:i,hass:n,sensors:s,config:o,localize:r,openEntityPopover:a}){var l,c,d,h,u,p,f;const{state:v,attributes:{hvac_action:g,current_temperature:m}}=e,y=null===(d=null===(c=null===(l=null==o?void 0:o.layout)||void 0===l?void 0:l.sensors)||void 0===c?void 0:c.labels)||void 0===d||d;let b=r(v,"component.climate.state._.");g&&(b=[r(g,"state_attributes.climate.hvac_action."),` (${b})`].join(""));const _=[Vt({hide:t.temperature,state:`${jt(m,Object.assign(Object.assign({},o),{locale:n.locale}))}${i||""}`,hass:n,details:{heading:!!y&&(null!==(u=null===(h=null==o?void 0:o.label)||void 0===h?void 0:h.temperature)&&void 0!==u?u:r("ui.card.climate.currently"))}}),Vt({hide:t.state,state:b,hass:n,details:{heading:!!y&&(null!==(f=null===(p=null==o?void 0:o.label)||void 0===p?void 0:p.state)&&void 0!==f?f:r("ui.panel.lovelace.editor.card.generic.state"))}}),...s.map(t=>{var{name:e,state:i}=t,s=gt(t,["name","state"]);return Vt({state:i,hass:n,localize:r,openEntityPopover:a,details:Object.assign(Object.assign({},s),{heading:y&&e})})})||null].filter(t=>null!==t);return Mt(o,_)}({_hide:this._hide,unit:u,hass:this._hass,entity:this.entity,sensors:this.sensors,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",D`
